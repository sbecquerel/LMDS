...
INSERT INTO `lmds_evtlog_data` VALUES (1,7,'2017-07-24 21:51:44',19,'VZN_EVT_CONNEXION','Core_Library_Controller_Auth_Index::_HandleAuthForm'),(2,NULL,'2017-07-24 22:10:22',16,'VZN_REC_INSERT','Core_Library_Resource_XML_VarSet::SimpleInsertData'),(3,7,'2017-07-24 22:15:33',19,'VZN_EVT_CONNEXION','Core_Library_Controller_Auth_Index::_HandleAuthForm'),(4,2,'2017-07-24 22:19:53',19,'VZN_EVT_CONNEXION','Core_Library_Controller_Auth_Index::_HandleAuthForm'),(5,7,'2017-07-24 22:20:45',19,'VZN_EVT_CONNEXION','Core_Library_Controller_Auth_Index::_HandleAuthForm'),(6,2,'2017-07-24 22:21:21',19,'VZN_EVT_CONNEXION','Core_Library_Controller_Auth_Index::_HandleAuthForm'),(7,2,'2017-07-24 22:23:52',16,'VZN_REC_INSERT','Core_Library_Resource_XML_VarSet::SimpleInsertData'),(8,7,'2017-07-24 22:24:07',19,'VZN_EVT_CONNEXION','Core_Library_Controller_Auth_Index::_HandleAuthForm');
...
INSERT INTO `lmds_evtlog_data_group` VALUES (1,1,1),(2,1,10),(3,1,11),(4,2,1),(5,2,8),(6,2,9),(7,2,10),(8,2,11),(9,2,17),(10,3,1),(11,3,10),(12,3,11),(13,4,1),(14,5,1),(15,5,10),(16,5,11),(17,6,1),(18,7,1),(19,8,1),(20,8,10),(21,8,11);
...
INSERT INTO `lmds_grp_data` VALUES (1,2,'Lundi matin',2,14,6,NULL,NULL,NULL),(2,2,'Lundi après-midi',2,20,7,NULL,NULL,NULL),(3,2,'Mardi matin',3,31,8,NULL,NULL,NULL),(4,2,'Mardi après-midi',3,41,8,NULL,NULL,NULL),(5,2,'Lundi 18h',8,37,8,NULL,NULL,NULL);
...
--
-- Table structure for table `lmds_movie_pdf_file_data`
--

DROP TABLE IF EXISTS `lmds_movie_pdf_file_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lmds_movie_pdf_file_data` (
  `id_data` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_owner` int(10) unsigned DEFAULT NULL,
  `sys_creation_date` datetime DEFAULT NULL,
  `sys_last_mod_date` datetime DEFAULT NULL,
...
--
-- Dumping data for table `lmds_movie_pdf_file_data`
--

LOCK TABLES `lmds_movie_pdf_file_data` WRITE;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_data` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lmds_movie_pdf_file_data_group`
--

DROP TABLE IF EXISTS `lmds_movie_pdf_file_data_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lmds_movie_pdf_file_data_group` (
  `id_data_group` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_data` int(10) unsigned NOT NULL,
  `id_group` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id_data_group`),
...
--
-- Dumping data for table `lmds_movie_pdf_file_data_group`
--

LOCK TABLES `lmds_movie_pdf_file_data_group` WRITE;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_data_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_data_group` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lmds_movie_pdf_file_data_group_mode`
--

DROP TABLE IF EXISTS `lmds_movie_pdf_file_data_group_mode`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lmds_movie_pdf_file_data_group_mode` (
  `id_data_group_mode` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `id_data_group` int(10) unsigned NOT NULL,
  `mode` int(10) unsigned NOT NULL,
  `date_valid` date DEFAULT NULL,
...
--
-- Dumping data for table `lmds_movie_pdf_file_data_group_mode`
--

LOCK TABLES `lmds_movie_pdf_file_data_group_mode` WRITE;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_data_group_mode` DISABLE KEYS */;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_data_group_mode` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `lmds_movie_pdf_file_deleted`
--

DROP TABLE IF EXISTS `lmds_movie_pdf_file_deleted`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `lmds_movie_pdf_file_deleted` (
  `id_data` int(10) unsigned NOT NULL,
  `id_owner` int(10) unsigned DEFAULT NULL,
  `sys_creation_date` datetime DEFAULT NULL,
  `sys_last_mod_date` datetime DEFAULT NULL,
...
--
-- Dumping data for table `lmds_movie_pdf_file_deleted`
--

LOCK TABLES `lmds_movie_pdf_file_deleted` WRITE;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_deleted` DISABLE KEYS */;
/*!40000 ALTER TABLE `lmds_movie_pdf_file_deleted` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `lmds_resource_data_group` VALUES (1,1,1),(2,2,1),(3,3,1),(18,4,2),(5,5,1),(6,6,1),(7,7,1),(8,8,1),(9,9,1),(16,10,2),(11,11,1),(12,12,2),(13,13,2),(14,14,2),(15,15,2),(17,16,2),(19,17,2),(20,18,2),(21,19,2),(22,20,2),(23,22,2);
...
INSERT INTO `lmds_resource_data_group_mode` VALUES (1,12,56,NULL),(2,13,56,NULL),(3,14,56,NULL),(4,15,56,NULL),(5,16,56,NULL),(6,17,56,NULL),(7,18,56,NULL),(8,19,56,NULL),(9,20,56,NULL),(10,21,56,NULL),(11,22,56,NULL),(12,23,56,NULL);
...
INSERT INTO `lmds_varsetmonitor_data` VALUES (1,NULL,2,1,21,'content','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<varset name=\"dicostatus\" prefix=\"dicostatus\" type=\"sys\" label=\"Dictionary status\">\n	<var uid=\"1\" id=\"id_dico\" type=\"fkey_varset\" mandatory=\"true\" default_label=\"ID Dico\" default_short_label=\"ID Dico\">\n		<fkey_varset'),(2,NULL,2,1,21,'name','varset.dicostatus.xml'),(3,NULL,2,1,21,'type','40'),(4,NULL,2,1,21,'description',''),(5,2,7,1,22,'content','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<varset name=\"movie_pdf_file\" prefix=\"movie_pdf_file\" type=\"join\" label=\"Movie PDF file\">\n    <var uid=\"1\" id=\"id_movie\" type=\"fkey_varset\">\n        <fkey_varset varset_name=\"movie\"/>\n    </var>\n    <var uid=\"2\" id=\"'),(6,2,7,1,22,'name','Movie - PDF File'),(7,2,7,1,22,'type','40'),(8,2,7,1,22,'description',''),(9,2,7,1,22,'resource_id','');
...
INSERT INTO `lmds_varsetmonitor_data_group` VALUES (1,1,1),(2,1,8),(3,1,9),(4,1,10),(5,1,11),(6,1,17),(7,2,1),(8,2,8),(9,2,9),(10,2,10),(11,2,11),(12,2,17),(13,3,1),(14,3,8),(15,3,9),(16,3,10),(17,3,11),(18,3,17),(19,4,1),(20,4,8),(21,4,9),(22,4,10),(23,4,11),(24,4,17),(25,5,1),(26,6,1),(27,7,1),(28,8,1),(29,9,1);
...
-- Dump completed on 2017-07-24 20:24:28
