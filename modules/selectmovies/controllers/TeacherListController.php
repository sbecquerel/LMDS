...
class Selectmovies_TeacherListController extends Core_Library_Controller_Action
{
	/**
	...
	public function getAction()
	{
		...
		if ( ! $oUser->HasRole( Lmds_Utils::ROLE_ADMIN ) ) {
	...
	protected function _commonRetrieveForm( Core_Library_Event_Context $oContext )
	{
		...
		$oForm->LoadFromFile( sprintf( '%s/modules/selectmovies/resources/teacherList/form.get.xml', APPLICATION_PATH ) );
