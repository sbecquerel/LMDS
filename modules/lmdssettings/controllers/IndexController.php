...
class Lmdssettings_IndexController extends Core_Library_Controller_Action
{
	/**
	...
	protected function _commonRetrieveForm( Core_Library_Event_Context $oContext )
	{
		...
		$oForm->LoadFromFile( sprintf( '%s/modules/lmdssettings/resources/index/form.get.xml', APPLICATION_PATH ) );
